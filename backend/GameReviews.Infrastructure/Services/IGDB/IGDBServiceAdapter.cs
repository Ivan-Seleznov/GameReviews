...
public class IGDBServiceAdapter(IGDBClient igdbClient) : IIGDBService
{
    ...
    public async Task<IGDBResponseDto<T[]>> QueryWithResponseAsync<T>(string endpoint, string query)
    {
    ...
    public async Task<int> CountAsync(string endpoint, string query)
    {
